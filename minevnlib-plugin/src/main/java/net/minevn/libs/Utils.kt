...
fun http(url: String, method: String, parameters: Map<String, String>?) : String {
...
fun get(url: String, parameters: Map<String, String>? = null) = http(url, "GET", parameters)

fun post(url: String, parameters: Map<String, String>? = null) = http(url, "POST", parameters)